...
private:
  ...
  void scanCycleGuards();
  bool needsCycleGuard(u32 source, u32 destination) const;
  llvm::BasicBlock *cycleGuardDestination(u32 source, u32 destination);
  ...
  std::vector<std::vector<u32>> guarded_successors_;
